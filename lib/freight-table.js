// lib/freight-table.js — tabela regional de frete (origem DF)
// Compartilhada entre api/freight.js (cotação) e api/payment.js (cobrança).
...
module.exports = { FREIGHT_TABLE, DEFAULT_FREIGHT };
